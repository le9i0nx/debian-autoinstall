...
cd ..
genisoimage -r -V "ubuntu auto install" -cache-inodes -J -l -b isolinux.bin  -c boot.cat -no-emul-boot -boot-load-size 4 -boot-info-table -o ubuntu-14.04-amd64-auto-install.iso iso/
rm -r /tmp/iso
